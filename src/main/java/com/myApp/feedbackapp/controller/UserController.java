...
public class UserController {
    ...
    public ResponseEntity<Feedback> submitFeedback(@RequestHeader("x-api-key") String apiKey, @RequestBody String content) {
    ...
    public ResponseEntity<String> editFeedback(@RequestHeader("x-api-key") String apiKey, @PathVariable String feedbackId, @RequestBody String newContent) {
        if (ApiKeyManager.isValidApiKey(apiKey)) {
            String username = userService.getUsernameByApiKey(apiKey);
